...
for case in ['c']: 
    ...
    modelRNN.fit(trainX, trainY, epochs=epochs, batch_size=batch_size, verbose=2)
    ...
    #Display results
    airlineUtils.displayResult(dataset, trainPredict, trainY, testPredict, testY, scaler, history, filename='lstm_b{}e{}'.format(batch_size,epochs)+case)
